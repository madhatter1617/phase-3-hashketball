...
#   game_hash.values.each {|info|
#     info[:players].each {|player_info|
#         return player_info if player_info[:player_name] == name
#     }
#   }
# end
# ​
...
# end
# ​
# def team_colors(name_of_team) #returns an array
#   game_hash.values.each do |info|
